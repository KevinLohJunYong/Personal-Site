          ...
          <h1>
           ...
           <ul>
             <li> 
              ...
              <li> 
                <h3> It shows the visualisation for the Breath First Search, Depth First Search, Dijskstra, Greedy Best First Search and A* Search algorithms </h3> 
              </li>
              <li> 
               <h3> It allows users to change the start and end nodes, add walls and see the visualisations of the different path finder algorithms </h3> 
              </li>
           </ul>
           ...
           <ul>
             <li> 
              ...
              <li> 
                <h3> It shows the visualisation for the Bubble Sort, Insertion Sort, Selection Sort, Comb Sort, Merge Sort and Quick Sort algorithms </h3> 
              </li>
           </ul>
           ...
           <ul>
             <li> 
               <h3> I decided to do a minor project for fun while learning the Django Framework and Bootstrap </h3> 
              </li>
              <li> 
                <h3> This website allows users to ask for help about anything and answer help others may have </h3> 
              </li>
              <li> 
           ...
           <li>
             <h3> I enjoy playing table tennis recreationally in my free time.
                I had represented the Computing Faculty in NUS in table tennis competitions and had played singles and doubles </h3>
           </li>
           <li>
             <h3> Though I would describe myself as an introvert, I still enjoy making new friends and socialising from time to time. I get along well with most people. </h3>
           </li>
           </ul>
        </div>
      </Layout>
